  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0,0,0,.65), rgba(0,0,0,.7)), url('" + img("about_hero_bg", "/assets/about/aboutImg1.jpeg") + "')"
        }}
      >
      ...
      <section className="container my-5">
        <div className="row align-items-center g-5">
          ...
          <div className="col-lg-6" data-aos="fade-left">
            <img
              src={img("about_right_image", "https://i.etsystatic.com/23334810/r/il/5f14ce/2318929070/il_fullxfull.2318929070_7cjm.jpg")}
      ...
      <section className="container my-5">
        <div className="row align-items-center g-5">
          ...
          >
            <img
              src={img("about_bottom_image", "/assets/about/aboutImg6.jpeg")}
